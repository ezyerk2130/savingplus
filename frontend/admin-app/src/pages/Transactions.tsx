...
export default function Transactions() {
  ...
  useEffect(() => {
    setLoading(true)
    api.get('/transactions', { params: { page, status: filterStatus || undefined } })
      .then((res) => {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-6">Transactions (Finance)</h1>
            ...
            <tbody className="divide-y">
              {txns.map((t) => (
                <tr key={t.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 font-medium">TZS {t.amount.toLocaleString()}</td>
